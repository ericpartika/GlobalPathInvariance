...
% UDP = udpport;
% 
% input = [40, 0]; %steer limits, 63deg (left) 40 straight 0deg(right), velocity 0-255
% write(UDP, input, "uint8", "169.233.126.183", 10002);
% 
% for i = 1:length(T) 
%     
%     input = [ang(i)*(180/pi)+40, vel(i)*100] %steer limits, 63deg (left) 40 straight 0deg(right), velocity 0-255
%     write(UDP, input, "uint8", "169.233.126.183", 10002);
%     pause(0.1)
% end
